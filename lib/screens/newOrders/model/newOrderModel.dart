...
//
//   NewOrderList({this.success, this.message, this.orderList});
//
//   NewOrderList.fromJson(Map<String, dynamic> json) {
...
class NewOrderList {
  ...
  NewOrderList({this.success, this.message, this.count, this.orderList});
