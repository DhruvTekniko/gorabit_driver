...
class OnGoingOrderList {
  ...
  OnGoingOrderList({this.success, this.message, this.count, this.orderList});

  OnGoingOrderList.fromJson(Map<String, dynamic> json) {
...
class Pickup {
  ...
  Pickup({this.name, this.address, this.lat, this.long,this.mobileNo});
